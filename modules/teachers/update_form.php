...
<body>
    ...
    <h1 class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-5 text-white pt-2 text-uppercase ">Profesores</h1>
    </header>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <h1 class="h2 text-uppercase">Editar Profesor </h1>
                ...
                <div class="form">
                    <form action="update_user.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-md" placeholder="Escribe el Email" name="email" value="<?php echo $record-> email;?>">
                        </div>
                        
                        <div class="mb-3">
                            <label for="" class="form-label">Contraseña</label>
                            <input type="text" class="form-control form-control-md" placeholder="Escribe el Contraseña" name="password" value="<?php echo $record-> password;?>">
                            <input type="hidden" name="id" value="<?php echo $id;?>">
                        </div>

                        <div class="mb-3">
                            <input type="submit" class="btn btn-success btn-lg" value="Editar">
                            <a href="../teachers/" class="btn btn-danger btn-lg">Regresar</a>
                        </div>
